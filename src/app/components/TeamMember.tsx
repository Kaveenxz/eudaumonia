  ...
  return (
    <div className="bg-[#F9FAFB] p-6 rounded-lg text-center" onClick={() => handleClick(id)}>
      ...
      <div className="mt-4 flex justify-center space-x-3">
        <a href={githubLink} className="text-gray-600 hover:text-gray-800">
          <FaGithub />
        </a>
        <a href={twitterLink} className="text-gray-600 hover:text-gray-800">
          <FaTwitter />
        </a>
        <a href={linkedinLink} className="text-gray-600 hover:text-gray-800">
          <FaLinkedin />
        </a>
      </div>
    </div>
