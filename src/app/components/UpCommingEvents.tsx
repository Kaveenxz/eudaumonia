  ...
  return (
    <div className='flex gap-14 border-2 rounded-3xl border-gray-300'>
      <div className='mt-6 mx-32'>
        <h2 className='text-5xl font-semibold text-[#D31145] text-center'>Up Comming Events</h2>
        <p className='text-lg mt-10 text-balance text-center'>
        ...
        <div className=' flex items-center justify-center my-10'>
          <button className='bg-[#B91A45] text-white px-14  text-lg py-3'>Join Now</button>
        </div>
      </div>
    </div>
  )
